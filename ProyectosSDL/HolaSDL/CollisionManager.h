...
public:
	CollisionManager() {};
	~CollisionManager() {};
	CollisionManager(SDLGame* game, BulletsManager* bulletsManager, AsteroidsManager* astroidManager/*, FightersManager* fightersManager*/); //recibe punteros para acceder	// a las balas, asteroides, nave...	virtual void handleInput(Uint32 time, const SDL_Event& event) {};
