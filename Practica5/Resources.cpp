...
std::vector<std::string> Resources::imageFiles_ { "images/blank.png",
		...
		"images/badges.png", "images/Vidilla.png","images/insignia.png", "images/fondo.jpg",  "images/escudo.png", "images/multi.png" };
...
void Resources::createInstance(SDLGame * game)
{
	if (instance_ == nullptr) {
		instance_ = new Resources(game);
	}
}
